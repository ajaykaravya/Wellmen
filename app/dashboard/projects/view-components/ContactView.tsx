            ...
            {section.rows?.map((row: any) => {
              ...
              return (
                <tr key={row.key} className="hover:bg-gray-50 dark:hover:bg-gray-800/50">
                  ...
                  <td className="px-6 py-4 text-gray-900 dark:text-gray-100">{name || <span className="text-gray-400">-</span>}</td>
                  <td className="px-6 py-4 text-gray-900 dark:text-gray-100">{mobile || <span className="text-gray-400">-</span>}</td>
                </tr>
              );
            })}
          </tbody>
