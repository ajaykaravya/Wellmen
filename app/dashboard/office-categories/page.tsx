...
function OfficeCategoryListContent() {
  ...
  const [confirmTarget, setConfirmTarget] = useState<OfficeCategoryRow | null>(null);
  ...
  const handleDeleteCategory = useCallback((row: OfficeCategoryRow) => {
      ...
      <section className="rbac-section rbac-container">
        <div className="rbac-card">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <h3 className="rbac-title-lg">Office work Categories</h3>
          ...
          <div className="mt-4">
            ...
            <div className="md:hidden space-y-3">
              ...
              {!loading && categories.length === 0 && (
                <div className="rbac-card py-4 text-sm text-slate-500">No office categories found.</div>
              )}
              {!loading &&
